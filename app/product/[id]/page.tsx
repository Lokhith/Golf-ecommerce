...
const products = [
  ...
  // Add the missing products with IDs 9 and 10
  {
    ...
    images: [
      ...
      "/titleist-tsi2-fairway-address.png",
    ],
    rating: 4.8,
    reviewCount: 132,
    stock: 8,
  ...
  },
  {
    ...
    images: [
      "/adidas-tour360-22-side-view.png",
      "/adidas-tour360-22-top-view.png",
      "/adidas-tour360-22-sole-closeup.png",
      "/adidas-tour360-22-back-view.png",
    ],
    rating: 4.9,
    reviewCount: 178,
    stock: 15,
