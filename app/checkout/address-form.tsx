  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="space-y-2 bg-muted/30 p-4 rounded-lg">
        ...
        >
          <div className="flex items-center space-x-2 border rounded-md p-3 bg-white dark:bg-gray-800 cursor-pointer hover:border-green-300 dark:hover:border-green-700 transition-colors">
